...
In this chapter, based on the competition model described in previous chapter, simulation would be implemented with changing the network structures. As the basic model, interconnected layers with random regular network would be provided. And the,  network structures would be altered by changing the internal and external edges with random regular network and Barabasi-Albert network. 
